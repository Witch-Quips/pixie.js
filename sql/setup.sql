...
('Amanda Hecht','https://github.com/amanda-hecht89','https://www.linkedin.com/in/amanda-hecht/','a','The Sun'),
('Amaya Alejandra','https://github.com/amayamaya','https://www.linkedin.com/in/amayamaya/','b','Strength'),
('David Francisco','https://github.com/dfrancisco26','https://www.linkedin.com/in/davidn0tdave/','c','The Hermit'),
('Niki Hite','https://github.com/nikihite','https://www.linkedin.com/in/nikihite/','d','The Star');
...
'Born in London to upper-class American parents, Smith moved through a sophisticated and cultured circle, spending her childhood in New York and then Jamaica, where she would be profoundly shaped by the folkloric history of that nation. Smith returned to New York in 1893, enrolling in Pratt Institute, though she would leave after two years to pursue her own interests, then returning to London following the death of her mother. Shes the worlds most famous occult artist but her name is almost unknown. Such is the enigma of Pamela Colman Smith (1878-1951), an early 20th-century artist, writer, and mystic. Smith created dreamy, Symbolist-inspired watercolors that won her acclaim in her youth, including three successful exhibitions at Alfred Stieglitzs famed New York gallery, 291, where she was the first non-photographic artist to have a show. She was also an intimate friend of Dracula writer Bram Stoker, poet William Butler Yeats, and the actress and artistic muse Ellen Terry, for whom Smith designed illustrations and stage sets. However, Smiths most lasting artistic contribution was undoubtedly her designs for the Rider-Waite tarot deck. Made in collaboration with mystic and scholar A.E. Waite, Smith created the Art-Nouveau-inspired imagery of mythical archetypes set against luminous monochromatic backgrounds. Released in 1909, the deck is now regarded as the standard set, with more than 100 million copies in circulation. Smiths imagery has become synonymous with tarot itself. And yet, for more than a century, Smith went wholly uncredited for her contribution. Her claim to the deck was only cemented by her iconic serpentine signature, a monogram she created while studying Japanese design, and which she embedded into the decoration for every Tarot card. Tarot is a visual device—and yet the visual artist who composed them was eclipsed by Waite, the scholar, and Rider, the manufacturer,” said Micki Pellerano, a New York-based artist, astrologer, and scholar of occult history, “Academics, with all their inertia and corporatism, are somehow more palatable to the public and valuable to the market than artistry and vision… little has changed.” The artists place in art history is still forming, however, and her contributions are more complex than a simple story of rediscovery. Her sexual orientation and her ethnic makeup also sparked curiosity. She lived for many years with Nora Lake, her companion and business partner, with whom she may have shared a romantic relationship. Others have speculated that Smith was of biracial descent, with an English American father and a mother of either Jamaican or East Asian ancestry—although not much evidence exists to lead to any decisive conclusions on the matter. What was certain is that Smith was regarded as “other” by those around her and which in turn inspired her approach to art-making.')
